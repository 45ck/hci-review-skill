---
name: "cognitive-friction-detector"
pack: "user-research-hci-pack"
purpose: "Identify points where memory load, ambiguity, attention switching, hidden state, or poor feedback makes the interface harder to use."
...
handoffs: ["usability-heuristic-reviewer", "wireframe-critic", "error-and-time-metrics-analyzer"]
---
# cognitive-friction-detector

## Purpose
Identify points where memory load, ambiguity, attention switching, hidden state, or poor feedback makes the interface harder to use.
