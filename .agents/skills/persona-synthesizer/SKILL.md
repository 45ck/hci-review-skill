...
purpose: "Synthesize provisional personas from research notes, stakeholder inputs, or inferred user groups while keeping confidence and evidence explicit."
...
handoffs: ["task-analysis-writer", "usability-test-planner", "navigation-flow-reviewer"]
---
# persona-synthesizer

## Purpose
Synthesize provisional personas from research notes, stakeholder inputs, or inferred user groups while keeping confidence and evidence explicit.
