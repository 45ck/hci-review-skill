---
name: "representative-task-writer"
pack: "user-research-hci-pack"
purpose: "Write realistic test tasks that reflect actual user goals without over-leading participants to the answer."
...
handoffs: ["usability-test-planner", "error-and-time-metrics-analyzer", "satisfaction-questionnaire-writer"]
---
# representative-task-writer

## Purpose
Write realistic test tasks that reflect actual user goals without over-leading participants to the answer.
