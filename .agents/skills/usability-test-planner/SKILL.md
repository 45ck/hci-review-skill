...
purpose: "Design a usability study with target users, representative tasks, success metrics, observation prompts, and evidence capture."
...
handoffs: ["representative-task-writer", "error-and-time-metrics-analyzer", "satisfaction-questionnaire-writer"]
---
# usability-test-planner

## Purpose
Design a usability study with target users, representative tasks, success metrics, observation prompts, and evidence capture.
