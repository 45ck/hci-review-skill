---
name: "interaction-type-selector"
pack: "user-research-hci-pack"
purpose: "Choose suitable interaction styles such as form-fill, direct manipulation, menu selection, conversation, or mixed interaction based on user and task needs."
...
handoffs: ["low-fidelity-prototype-planner", "high-fidelity-prototype-planner", "conceptual-model-designer"]
---
# interaction-type-selector

## Purpose
Choose suitable interaction styles such as form-fill, direct manipulation, menu selection, conversation, or mixed interaction based on user and task needs.
