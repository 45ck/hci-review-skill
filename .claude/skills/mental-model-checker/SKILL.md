---
name: "mental-model-checker"
pack: "user-research-hci-pack"
purpose: "Evaluate whether the system concept, labels, and workflow align with how target users are likely to think about the task."
...
handoffs: ["conceptual-model-designer", "cognitive-friction-detector", "wireframe-critic"]
---
# mental-model-checker

## Purpose
Evaluate whether the system concept, labels, and workflow align with how target users are likely to think about the task.
